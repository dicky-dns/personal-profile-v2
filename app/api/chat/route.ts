...
function buildPrompt(message: string): string {
  return [
    ...
    "jika pertanyaaan memakai bahasa inggris, jawab dengan bahasa inggris dan jawaban seterusnya pake bahasa inggris sebelum user meminta ganti bahasa.", 
    "jika memakai bahasa indonesia, jawab dengan bahasa indonesia.",
    "jika disuruh ganti ke bahasa lain, jawab dengan bahasa itu, dan jawaban seterusnya memakai bahasa yang diinginkan.",
    "",
    "Profil:",
    `Nama: ${profile.name}`,
